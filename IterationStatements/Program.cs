...
namespace IterationStatements
{
    public class Program
    {
        ...
        public static void EvenOrOdd()
        {
            ...
            var evenOdd = (g % 2 == 0) ? "The number is even." : "The number is odd.";
        ...
        {
            Console.WriteLine("\n Please choose a number between -100 and 100:");
            int r = int.Parse(Console.ReadLine());

            var positiveNumber = (r >= 0) ? "The number is positive." : "The number is negative.";
